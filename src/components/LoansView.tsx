    ...
    <div className="space-y-4 pb-20">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          <h2 className="text-xl font-bold text-slate-100 flex items-center gap-2">
            <Landmark className="w-5 h-5 text-emerald-400" /> Préstamos
          </h2>
          ...
          {filteredPrestamos.map((prestamo: Prestamo) => {
            ...
            return (
              <div
                ...
                className="bg-slate-800/80 hover:bg-slate-800 border border-slate-700/80 rounded-2xl p-4 cursor-pointer transition-all hover:border-slate-600 shadow-sm space-y-3 group"
              >
                ...
                <div className="grid grid-cols-3 gap-2 bg-slate-900/60 p-2.5 rounded-xl text-xs border border-slate-700/50">
                  <div>
                    <span className="text-[10px] text-slate-400 block">Prestado</span>
                    <span className="font-bold text-slate-200">
                      {formatCurrency(prestamo.monto_prestado)}
                    </span>
                  </div>
                  <div>
                    <span className="text-[10px] text-slate-400 block">Tasa ({prestamo.tasa_interes}%)</span>
        ...
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-slate-900 border border-slate-800 rounded-2xl max-w-md w-full p-5 space-y-4 shadow-2xl">
            <div className="flex items-center justify-between border-b border-slate-800 pb-3">
              <h3 className="text-base font-bold text-slate-100">Nuevo Préstamo</h3>
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-800 border border-slate-700 rounded-xl px-3 py-2 text-xs font-black text-emerald-400 focus:outline-none"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-800 border border-slate-700 rounded-xl px-3 py-2 text-xs font-bold text-blue-400 focus:outline-none"
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-800 border border-slate-700 rounded-xl px-3 py-2 text-xs font-bold text-slate-100 focus:outline-none"
                  />
                </div>
      ...
      {selectedPrestamo && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-3 overflow-y-auto">
          <div className="bg-slate-900 border border-slate-800 rounded-2xl max-w-lg w-full p-5 space-y-4 shadow-2xl max-h-[92vh] flex flex-col">
            ...
            <div className="space-y-3 overflow-y-auto pr-1 flex-1">
              <div className="bg-slate-800/80 p-3 rounded-xl border border-slate-700/60 grid grid-cols-2 gap-2 text-xs">
                <div>
                  <span className="text-slate-400 text-[10px] block">Monto Prestado</span>
                  <span className="font-bold text-slate-100">
                    {formatCurrency(selectedPrestamo.monto_prestado)}
                  </span>
                </div>
                <div>
                  <span className="text-slate-400 text-[10px] block">Total a Pagar</span>
                        ...
                        <div className="flex items-center justify-end gap-1.5">
                          {cuota.estado !== 'pagada' ? (
                            <button
                              ...
                              className="px-2.5 py-1 bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-bold rounded-lg text-[10px] transition-all shadow-sm"
                            >
                              Registrar Pago
                            </button>
                          ) : (
                          ...
                          <a
                            ...
                            className="p-1 text-emerald-400 hover:text-emerald-300 bg-emerald-500/10 rounded-md border border-emerald-500/30"
